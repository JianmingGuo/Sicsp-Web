...
from Grass.views import grass_main,grass_download
from ToMulVAL.views import toMulVAL,tomulvalupload,tomulvaldownload,tomulvalerror1,GetData,GenMulval,PostData,tomulvaldownload1,setlist,GetList
...
urlpatterns = [
    ...
    path('list/',setlist,name="list"),
    path('grass/',grass_main, name="grass_main"),
    path('grass/download',grass_download),
    ...
    path('ToMulVAL/tomulvaldownload1/',tomulvaldownload1),
